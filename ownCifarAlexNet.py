...
def main():
    ...
    model = torch.hub.load('pytorch/vision', 'alexnet', pretrained=True).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        test(args, model, device, test_loader, stats)
    if (args.save_model):
        torch.save(model.state_dict(), "myAlexNet.pt")
    f1 = open('stats1_alexnet.txt', 'a+')
    f2 = open('stats2_alexnet.txt', 'a+')
    print('Statistics:\n')
